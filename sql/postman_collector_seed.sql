...
BEGIN
    ...
    VALUES (@collectorUserId, @enterpriseId, 'collector@test.com', N'Test Collector', 'EMP-TEST-001', N'Xe tải nhỏ', '59C-00001', 'AVAILABLE', 10.77690000, 106.70090000, @now, 0, 0, 0.00, @now);
